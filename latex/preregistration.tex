...
\section{Timeline and data access}

Pre-registration on OSF precedes any analysis of real data in the TRE.
\todo{Dates; TRE export checklist (mirror Konsumtionskollen RUN\_TRE pattern).}
